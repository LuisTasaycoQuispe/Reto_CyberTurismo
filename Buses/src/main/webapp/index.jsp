...
<body>
						...
						<div class="row">
							<div class="col-md-3 col-sm-3 col-xs-3">
								<span class="help-block text-muted small-font"
									style="font-weight: bold;">PLACA</span> <select
									class="form-select" aria-label="Default select example"
									id="ctrlRutaID" style="margin-top: 15px;">
							...
							<div class="col-md-2 col-sm-2 col-xs-2" id="BuscarInactivos"
								...
								<button type="button" class="btn btn-light border-black"
									...
									name="btnBuscarInactivos"></button>
							</div>
	...
	<script type="text/javascript" src="JS/crudBuses5.js"></script>
